...
namespace DioProjetoSeries
{
    class Program
    {
        ...
        {
            Console.Write("Digite o ID da série desejado: ");
            int indiceSerie = int.Parse(Console.ReadLine());
        ...
        private static void ListarSerie()
        {
            ...
            foreach (var serie in lista)
            {
                ...
                Console.WriteLine("#Id {0}: - {1} {2}", serie.retornaExcluido(), serie.retornaTitulo(), (excluido ? "*Excluído*" : ""));
            }
        }
        ...
        private static void InserirSerie()
        {
            ...
            Console.WriteLine("Digite o gênero entre as seguintes opções acima: ");
            int entradaGenero = int.Parse(Console.ReadLine());
